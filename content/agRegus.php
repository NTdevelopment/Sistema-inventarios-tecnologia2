...
isset($_POST['fecha']) && !empty($_POST['area']) &&
...
mysql_query("INSERT INTO usuarios (soid, nombre, apellido, email, fecha, password, area, ubicacion, centrocostos, telefono, enviado)
VALUES ('{$_POST['soid']}','{$_POST['nombre']}','{$_POST['apellido']}','{$_POST['email']}','{$_POST['fecha']}','{$_POST['password']}','{$_POST['area']}','{$_POST['ubicacion']}','{$_POST['centrocostos']}','{$_POST['telefono']}','{$_POST['enviado']}')",$link);
...
echo '<meta http-equiv="Refresh" content="5;URL=RegUs.php" />';
